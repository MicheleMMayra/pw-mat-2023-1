/*
 Fuanção tradicional com 1 parâmetro e 1 linha de corpo contendo return 
*/
function quadrado (n) {
    return n * n 
}
...
//Função equivalente no formato arrow fuction 
const quadradoA = n => n*n 

console.log('Arrow function: ', quadrado(7))

/*
  Função tradicional com mais de 1 parâmentro 
...
//Arrow fuction equivalente 
//Os parênteses devem estar presentes, mesmo que não haja parâmentro 
const aleatorio0a9A = () => Math.floor(Math.random() * 10)

console.log('Aleatório arrow: ', aleatorio0a9())
